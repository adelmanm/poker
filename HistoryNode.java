...
public class HistoryNode implements History, ChanceNode, DecisionNode, TerminalNode 
{
	...
	@Override 
	public float get_utility(int player) // Terminal node // this actually means "get_payoff", since it doesn't include probabilities (algorithm part)
	{
		if (this.is_terminal()) 
		{
			int pay_off_sum=2;
